...
// Iterate over each room and get its details from the user
   for (int r =1;r <= numRooms;r++) {
	   System.out.println("Enter the name of the room" +r+ ":");
	   String number = scanner.nextLine();
	   System.out.println("Enter the seating capacity" +r+ ":");
...
// Iterate over each meeting time and get its details from the user
   for(int m = 1;m <=numMeetingTimes;m++) {
	   System.out.println("Enter Meeting Time id" +m+ ":");
	   String id =scanner.nextLine();
	   System.out.println("Enter Meeting Time" +m+ ":");
...
// Get the number of instructors
   ...
   for(int t = 1;t <=nbrInstructors;t++) {
	   System.out.println("Enter Instructor id" +t+ ":");
	   String id =scanner.nextLine();
	   System.out.println("Enter Instructor name" +t+ ":");
