...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        driver.updateGenerationLabel(generationNumber, population.getSchedules().get(0).getFitness(), population.getSchedules().get(0).getNumbOfConflicts());
    ...
    private void setupTable() {
        JFrame frame = new JFrame("Class Schedule - GAschedules");
        ...
        fitnessLabel = new JLabel(); // Create fitness label
        frame.add(fitnessLabel, BorderLayout.SOUTH);
    ...
    private void updateGenerationLabel(int generationNumber, double fitness, int conflicts) {
        generationLabel.setText("Generation: " + generationNumber + " | Fitness: " + fitness + " | Conflicts: " + conflicts);
    }
