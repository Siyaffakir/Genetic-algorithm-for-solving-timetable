...
public class GeneticAlgorithm {
 ...
 // Perform crossover between two schedules
    ...
    // Mutate the population by applying mutation to each schedule
 ...
 // Select a tournament population for crossover
