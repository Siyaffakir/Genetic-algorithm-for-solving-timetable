...
public Schedule initialize() {
	// Initialize the schedule by creating classes for each department and course
...
private double calculateFitness() {
	numbOfConflicts = 0;
	classes.forEach(x -> {
		if(x.getRoom().getSeatingCapacity() < x.getCours().getMaxNumbOfStudents()) numbOfConflicts++;
